...
public class GradingServiceTests
{
    ...
    public void CalculateLetterGrade_HighScore_ReturnsDistinction()
    {
        ...
        // Act
        var result = service.CalculateLetterGrade(
            score: 85m,
            maxScore: 100m);
    ...
    [InlineData(70, 100, GradeLevel.Distinction)]     // Distinction boundary
    [InlineData(50, 100, GradeLevel.Pass)]            // Pass boundary
    [InlineData(-1, 100, GradeLevel.Invalid)]         // Negative score
    [InlineData(101, 100, GradeLevel.Invalid)]        // Score exceeds max
